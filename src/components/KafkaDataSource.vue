...
const isDrawerOpen = inject('kafkaDrawerOpen', false) // 父页面传递的数据，抽屉是否打开
	...
	<el-drawer ref="drawer" v-model="isDrawerOpen"  :title="drawerTitle" :destroy-on-close = "true" @open="drawerOpen" @opened="drawerOpened" size="50%">
		<el-main>
			<el-form ref='form' :model="dataSource" label-position="top" label-width="100px">
				...
				<el-form-item prop="ext_info.topic" label="topic" :rules="rules.topic">
					<el-input v-model="dataSource.ext_info.topic"/>
				</el-form-item>
			</el-form>
		</el-main>
